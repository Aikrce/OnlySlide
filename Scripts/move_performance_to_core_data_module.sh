...
# 显示要执行的操作
echo "准备将性能监控相关文件移动到CoreDataModule..."

# 源目录和目标目录
SOURCE_DIR="Sources/Core/Data/Persistence/CoreData/Performance"
TARGET_DIR="Sources/CoreDataModule/Performance"
